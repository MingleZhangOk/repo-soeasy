(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fortawesome/free-solid-svg-icons'), require('@fortawesome/angular-fontawesome'), require('@angular/common/http'), require('@angular/forms'), require('@ngx-translate/http-loader'), require('@ng-bootstrap/ng-bootstrap'), require('@ngx-translate/core'), require('@angular/common'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ng-jhipster', ['exports', '@fortawesome/free-solid-svg-icons', '@fortawesome/angular-fontawesome', '@angular/common/http', '@angular/forms', '@ngx-translate/http-loader', '@ng-bootstrap/ng-bootstrap', '@ngx-translate/core', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['ng-jhipster'] = {}),global.freeSolidSvgIcons,global.angularFontawesome,global.ng.common.http,global.ng.forms,global.httpLoader,global.ngBootstrap,global.i1,global.ng.common,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,freeSolidSvgIcons,angularFontawesome,http,forms,httpLoader,ngBootstrap,i1,common,rxjs,operators,i0) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var JhiConfigService = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiConfigService.ctorParameters = function () {
            return [
                { type: JhiModuleConfig }
            ];
        };
        /** @nocollapse */ JhiConfigService.ngInjectableDef = i0.defineInjectable({ factory: function JhiConfigService_Factory() { return new JhiConfigService(i0.inject(JhiModuleConfig)); }, token: JhiConfigService, providedIn: "root" });
    ...
    var JhiItemCountComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiItemCountComponent.ctorParameters = function () {
            return [
    ...
    var JhiBooleanComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiBooleanComponent.ctorParameters = function () {
            return [
                { type: JhiConfigService }
            ];
        };
    ...
    var JhiSortByDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiSortByDirective.ctorParameters = function () {
            return [
        ...
        JhiSortByDirective.propDecorators = {
            ...
            iconComponent: [{ type: i0.ContentChild, args: [angularFontawesome.FaIconComponent,] }],
    ...
    var JhiLanguageService = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiLanguageService.ctorParameters = function () {
            return [
                { type: i1.TranslateService },
                { type: JhiConfigService }
            ];
        };
        /** @nocollapse */ JhiLanguageService.ngInjectableDef = i0.defineInjectable({ factory: function JhiLanguageService_Factory() { return new JhiLanguageService(i0.inject(i1.TranslateService), i0.inject(JhiConfigService)); }, token: JhiLanguageService, providedIn: "root" });
    ...
    var JhiTranslateDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiTranslateDirective.ctorParameters = function () {
            return [
                { type: JhiConfigService },
                { type: i0.ElementRef },
                { type: i1.TranslateService }
    ...
    var JhiThreadModalComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiThreadModalComponent.ctorParameters = function () {
            return [
    ...
    var JhiJvmThreadsComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiJvmThreadsComponent.ctorParameters = function () {
            return [
         ...
         */
            function (value) {
                ...
                try {
                    ...
                    try {
                        if (valueKeys_1_1 && !valueKeys_1_1.done && (_a = valueKeys_1.return))
                            _a.call(valueKeys_1);
                    }
                    finally {
                        if (e_1)
    ...
    var JhiAlertService = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiAlertService.ctorParameters = function () {
            return [
                { type: i0.Sanitizer },
                { type: JhiConfigService },
                { type: i1.TranslateService }
        ...
        /** @nocollapse */ JhiAlertService.ngInjectableDef = i0.defineInjectable({ factory: function JhiAlertService_Factory() { return new JhiAlertService(i0.inject(i0.Sanitizer), i0.inject(JhiConfigService), i0.inject(i1.TranslateService)); }, token: JhiAlertService, providedIn: "root" });
    ...
    var JhiPaginationUtil = /** @class */ (function () {
        ...
        /** @nocollapse */ JhiPaginationUtil.ngInjectableDef = i0.defineInjectable({ factory: function JhiPaginationUtil_Factory() { return new JhiPaginationUtil(); }, token: JhiPaginationUtil, providedIn: "root" });
    ...
    var JhiResolvePagingParams = /** @class */ (function () {
        ...
        /** @nocollapse */
        JhiResolvePagingParams.ctorParameters = function () {
            return [
                { type: JhiPaginationUtil }
            ];
        };
        /** @nocollapse */ JhiResolvePagingParams.ngInjectableDef = i0.defineInjectable({ factory: function JhiResolvePagingParams_Factory() { return new JhiResolvePagingParams(i0.inject(JhiPaginationUtil)); }, token: JhiResolvePagingParams, providedIn: "root" });
     ...
     * @return {?}
     */
    function translatePartialLoader(http$$1) {
        return new httpLoader.TranslateHttpLoader(http$$1, 'i18n/', ".json?buildTimestamp=" + process.env.BUILD_TIMESTAMP);
    }
    /**
     * @param {?} configService
     * @return {?}
    ...
    var NgJhipsterModule = /** @class */ (function () {
                    ...
                    providers: [
                        {
                            ...
                            deps: [i1.TranslateService, JhiConfigService]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            deps: [i0.Sanitizer, JhiConfigService, i1.TranslateService]
                        },
        ...
        NgJhipsterModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        exports: __spread(JHI_PIPES, JHI_DIRECTIVES, JHI_COMPONENTS, [JhiTranslateDirective, i1.TranslateModule, common.CommonModule])
                    },] }
        ];
    ...
    var JhiParseLinks = /** @class */ (function () {
        ...
        /** @nocollapse */ JhiParseLinks.ngInjectableDef = i0.defineInjectable({ factory: function JhiParseLinks_Factory() { return new JhiParseLinks(); }, token: JhiParseLinks, providedIn: "root" });
    ...
    var JhiDateUtils = /** @class */ (function () {
        ...
        /** @nocollapse */ JhiDateUtils.ngInjectableDef = i0.defineInjectable({ factory: function JhiDateUtils_Factory() { return new JhiDateUtils(); }, token: JhiDateUtils, providedIn: "root" });
        return JhiDateUtils;
    }());
    ...
    var JhiEventManager = /** @class */ (function () {
        ...
        /** @nocollapse */ JhiEventManager.ngInjectableDef = i0.defineInjectable({ factory: function JhiEventManager_Factory() { return new JhiEventManager(); }, token: JhiEventManager, providedIn: "root" });
