...
public class UTC2LaterOneDateString_UDF extends ScalarFunction implements MyAll_UDATF<UTC2LaterOneDateString_UDF> {
    ...
    public String eval(Timestamp timestamp) {
        Instant instant = Instant.ofEpochMilli(timestamp.getTime() - 60 * 1000 + 8 * 60 * 60 * 1000);
